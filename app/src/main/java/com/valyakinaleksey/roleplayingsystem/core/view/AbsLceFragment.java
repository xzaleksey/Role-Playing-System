...
public abstract class AbsLceFragment<C extends HasPresenter, M extends RequestUpdateViewModel, V extends LceView<M>>
  ...
  @Override protected void setupViews(final View view) {
  ...
  @Override public void showMessage(CharSequence message, @MessageType int type) {
    switch (type) {
      case TOAST:
  ...
  @Override public void preFillModel(M data) {
