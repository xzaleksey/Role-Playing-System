...
@PerFragmentScope
public class GamesDescriptionPresenterImpl
    ...
    public void getData() {
        ...
        compositeSubscription.add(
                Observable.zip(userGetInteractor.getUserByUid(gameModel.getMasterId()),
                        ...
                        .subscribe(compoundModel -> {
                            updateInfoSections(gameModel, compoundModel.user, compoundModel.gameCharacteristicModels, compoundModel.gameClassModels,
                                    compoundModel.gameRaceModels);
    ...
    private static class CompoundModel {

        private User user;
        private List<GameCharacteristicModel> gameCharacteristicModels;
        private List<GameClassModel> gameClassModels;
        private List<GameRaceModel> gameRaceModels;

        public CompoundModel(User user, List<GameCharacteristicModel> gameCharacteristicModels, List<GameClassModel> gameClassModels, List<GameRaceModel> gameRaceModels) {
            this.user = user;
            this.gameCharacteristicModels = gameCharacteristicModels;
            this.gameClassModels = gameClassModels;
            this.gameRaceModels = gameRaceModels;
        }
    }
}
