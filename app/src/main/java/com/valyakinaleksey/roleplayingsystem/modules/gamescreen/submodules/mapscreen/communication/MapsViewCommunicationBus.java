...
@PerFragmentScope
public class MapsViewCommunicationBus
        extends SelfRestorableNavigationLceCommunicationBus<MapsViewModel, MapsView, MapsPresenter, MapsViewState>
    ...
    @Inject
    public MapsViewCommunicationBus(MapsPresenter presenter, MapsViewState viewState) {
