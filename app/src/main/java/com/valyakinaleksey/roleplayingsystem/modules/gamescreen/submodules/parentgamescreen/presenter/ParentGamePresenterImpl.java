...
public class ParentGamePresenterImpl extends BasePresenter<ParentView, ParentGameModel> implements ParentGamePresenter {
    ...
    public ParentGamePresenterImpl(CheckUserJoinedGameInteractor checkUserJoinedGameInteractor, ObserveGameInteractor observeGameInteractor, ParentPresenter parentPresenter, DeleteGameInteractor deleteGameInteractor) {
    ...
    public void getData() {
        ...
        compositeSubscription.add(observeGameInteractor.observeGameModelChanged(gameModel)
                .subscribe(gameModel1 -> {
                    viewModel.setGameModel(gameModel1);
                    view.preFillModel(viewModel);
                }, Crashlytics::logException));
        compositeSubscription.add(observeGameInteractor.observeGameModelRemoved(gameModel)
                .subscribe(gameModel1 -> {
