...
public class ParentGameFragment
  ...
  @Override protected void setupViews(View view) {
    super.setupViews(view);
    bottomNavigation.setOnMenuItemClickListener(new BottomNavigation.OnMenuItemSelectionListener() {
      @Override public void onMenuItemSelect(int id, int i1, boolean b) {
        switch (id) {
      ...
      @Override public void onMenuItemReselect(int i, int i1, boolean b) {
