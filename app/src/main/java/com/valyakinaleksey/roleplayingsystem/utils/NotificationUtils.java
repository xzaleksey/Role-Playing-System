...
public class NotificationUtils {
     ...
     */
    public static void showProgressNotification(int notifId, String caption, long completedUnits, long totalUnits) {
        ...
        NotificationManager manager = (NotificationManager) RpsApp.app().getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    private static NotificationCompat.Builder getCommonBuilder() {
        return new NotificationCompat.Builder(RpsApp.app(), COMMON);
    }
    ...
    public static void showFinishedNotification(int notifId, String caption, Intent intent,
        ...
        android.support.v4.app.NotificationCompat.Builder builder = getCommonBuilder()
                .setSmallIcon(icon)
                .setContentTitle(getStringById(R.string.app_name))
                .setContentText(caption)
                .setAutoCancel(true)
    ...
    private void showUploadFinishedNotification(int notifId, @Nullable Uri downloadUrl,
        ...
        Intent intent = new Intent(RpsApp.app(), ParentActivity.class).putExtra(EXTRA_DOWNLOAD_URL, downloadUrl)
