...
public class ScrollingAppbarFABBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
  private int toolbarHeight;

  public ScrollingAppbarFABBehavior(Context context, AttributeSet attrs) {
    super(context, attrs);
