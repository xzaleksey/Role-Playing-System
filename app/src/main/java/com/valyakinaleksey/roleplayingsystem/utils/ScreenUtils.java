...
public class ScreenUtils {
  ...
  public static int getDimensionSizeFromResources(Context context, @DimenRes int resId) {
  ...
  /**
   * Converts the given scale-independent Pixels. (SP) value into the corresponding pixels
   * value for the current screen.
   *
   * @param context Context instance
   * @param sp The SP value to convert
   * @return The pixels value for the current screen of the given SP value.
   */
  ...
  /**
   * Returns the current screen dimensions in device independent pixels (DIP) as a {@link Point}
   * object where
   ...
   * </ul>
   * <p>
   * See http://developer.android.com/reference/android/content/res/Configuration.html#screenLayout
   * for more details.
   *
   * @param context Context instance
